...
const CACHE = 'letterpad-v2';
const FILES = ['./', './index.html', './math.html', './manifest.webmanifest',
               './icon-180.png', './icon-512.png', './icon-math-180.png'];
  ...
  if (wantsPage){
    ...
    e.respondWith(
      fetch(req)
        ...
        // offline: give back THIS page, not whichever page was cached first
